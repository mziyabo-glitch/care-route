...
import { createCarerAction } from "./actions";

export function CreateCarerModal({
  agencyId,
  onClose,
}: {
  agencyId: string;
  ...
  async function handleSubmit(formData: FormData) {
    setError("");
    const result = await createCarerAction(agencyId, formData);
    if (result.error) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lg font-semibold text-gray-900">Add carer</h2>
